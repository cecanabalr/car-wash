...
pipeline {
  ...
  stages{
    ...
    stage('Static Code Analysis') {
      steps{
        sonarqubeMasQualityGatesP(sonarKey:'co.com.ceiba.adn:Ceiba.CarWash.carlos.canabal',
        sonarName:'Ceiba-CarWash-carlos.canabal',
  ...
  post {
    ...
    failure {
      ...
      mail (to: 'carlos.canabal@ceiba.com.co',
